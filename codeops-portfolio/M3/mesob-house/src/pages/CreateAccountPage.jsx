...
/**
 * CreateAccountPage — assembles the header, the two-column body and the footer.
 * Registration is handled by the shared store (localStorage-backed accounts);
 * a successful sign-up also signs the guest in and pre-fills their checkout
 * contact details.
 */
export default function CreateAccountPage() {
  const navigate = useNavigate();
  const { register, socialSignIn } = useStore();
