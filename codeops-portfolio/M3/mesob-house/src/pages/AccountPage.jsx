...
function preferenceLabel(value) {
  return dietaryOptions.find((option) => option.value === value)?.label ?? value;
}
        ...
        {session ? (
          <div className="account-layout">
            <Card variant="raised" className="account-card">
              ...
              <Button variant="outline" leftIcon={<FiLogOut />} onClick={handleSignOut}>
                Sign Out
              </Button>
            </Card>
            ...
            <Card variant="panel" className="account-favorites">
              <h2>
                <FiHeart aria-hidden="true" /> Your Favorites ({favorites.length})
              </h2>

              {favorites.length === 0 ? (
                <p className="account-favorites__empty">
                  Dishes you save from the menu will show up here — look for "Save to Favorites" on any dish.
                </p>
              ) : (
          ...
          <Card variant="raised" className="account-guest">
            ...
            <p>Sign in to see your details, saved favorites, and manage your feasts.</p>
