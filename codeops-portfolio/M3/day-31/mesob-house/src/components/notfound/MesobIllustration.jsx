/**
 * MesobIllustration — a small decorative SVG: a steaming mesob cover over an
 * empty plate. Purely presentational; colors follow the theme tokens.
 */
export default function MesobIllustration({ size = 88 }) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <g style={{ stroke: "var(--c-gold)" }} strokeWidth="3" strokeLinecap="round">
      ...
      <ellipse cx="60" cy="94" rx="38" ry="9" style={{ fill: "var(--c-panel-2)" }} />
      <ellipse cx="60" cy="91" rx="30" ry="6" style={{ fill: "var(--c-surface)" }} />
      <path
